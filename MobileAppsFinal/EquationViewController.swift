...
var Equations = [Equation]()
    override func viewDidLoad() {
        ...
        let chemEquationTwentyOne = Equation(equiName: "Entropy change of heat flow at constant temps", equation: "∆S=q/T")
        let chemEquationTwentyTwo = Equation(equiName: "Calculating the molarity of a solution", equation: "m=moles of solute/1000g solvent")
        let chemEquationTwentyThree = Equation(equiName: "Henry's law for calculating solubility", equation: "c=kP")
        let chemEquationTwentyFour = Equation(equiName: "Boiling point elevatation", equation: "∆Tᵇ=Kᵇm")
        let chemEquationTwentyFive = Equation(equiName: "Freezing point depression", equation: "∆Tᶠ=Kᶠm")
        let chemEquationTwentySix = Equation(equiName: "Osmotic pressure of a solution", equation: "π=MRT")
        let chemEquationTwentySeven = Equation(equiName: "Relationship between concentratio and time for first-order reaction", equation: "[A]o/[A]=kt")
        let chemEquationTwentyEight = Equation(equiName: "Equation for the graphical determination of k for a first-order reaction", equation: "ln[A]=-kt+ln[A]o")
        let chemEquationTwentyNine = Equation(equiName: "Half-life for a first-order reaction", equation: "t.5=ln2/k=0.693/k")
        let chemEquationThirty = Equation(equiName: "Relationship between concentration and time for a second-order reaction", equation: "1/[A]=1/[A]+kt")
